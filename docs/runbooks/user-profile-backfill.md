...
背景详见：
- `openspec/changes/user-profile-split/proposal.md`
- `openspec/changes/user-profile-split/design.md`（D1–D7）
- `docs/user-domain-modeling-plan.md` §4 Phase 1
