...
public class DatabaseInitializer {
    ...
    private static final List<String> SCHEMA_QUERIES = List.of(
            ...
            "CREATE INDEX rhizodelta_human_post_topic_id_idx IF NOT EXISTS FOR (n:Human_Post) ON (n.topic_id)",
            "CREATE INDEX rhizodelta_ai_consensus_created_at_idx IF NOT EXISTS FOR (n:AI_Consensus) ON (n.created_at)",
            "CREATE INDEX rhizodelta_ai_consensus_topic_id_idx IF NOT EXISTS FOR (n:AI_Consensus) ON (n.topic_id)",
